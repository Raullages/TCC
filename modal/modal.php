<div class="bg-principal">
	<form method="GET"  id="infoProjeto">
		...
		<div class="container-fluid info-zoneamento">
			...
			<div class=" col-md-3">
				<span data-toggle="tooltip" data-placement="top" title="Ex: Unifamiliar - Multifamiliar">Tipo de Uso</span><i style="color: red">*</i>
		...
		<div class="container-fluid dados-projeto">
			...
			<div class="col-md-2" style="margin-top: 40px;">
				<span>Altura na dívisa (m)</span>
				<input type="text" class="form-control" maxlength="4" id="cotas5" name="altura-divisa" >
				
			</div>
			<div class="col-md-2" style="margin-top: 40px;">
				<span>Altura máxima (m)</span>
				<input type="text" class="form-control" maxlength="4" id="cotas6" name="altura-maxima" >
				
			</div>
			<!-- <div class="col-md-2" style="margin-top: 10px;">
				<span>Nº Piso</span>
				<input type="number" class="form-control" id="" name="num_piso" >
