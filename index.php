...
<body>
	<img src="./img/projeto.jpg" style="position:fixed; opacity: 0.3; border: 1px solid #aaa;" alt="Projeto Arquitetônico">
	...
	<!-- Modal confirmação -->
	<div class="modal-confirmacao animated fadeInDown"><h3><i class="fa fa-check"></i> Relatório Gerado com Sucesso!</h3>
	</div>
