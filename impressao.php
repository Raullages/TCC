...
<tr>
<!-- Nome Projeto -->
    <td class='text-center'> $nome_proj  </td>;
    <td class='text-center'> $zoneamento </td>
    <td class='text-center'> $iptu </td>
    <!-- Area edificação -->
    <td class='text-center'> $area_edificacao  m²</td>
    <td class='text-center'> $area_lote_real  m²</td>     
    <td class='text-center'> $area_cp  m²</td>
</tr>
</tbody>
</table>
</td>
...
<td style='width:50%' class='text-left'>Reprovado. De acordo com a lei 079/2009, afastamento lateral é de no minímo <strong> $afast_lateral_minimo  m</strong> e de acordo com o projeto é de:  $afast_latDir m.
...
$html .="<tr >
        ...
        <td class='text-center'> $afast_lateral_minimo  m</td>
        <td class='text-center'><i class='fas fa-times-circle fa-lg' style='color: #e00; margin-top: 5%;'></></td>
        <td style='width:50%' class='text-left'>Reprovado. De acordo com a lei 079/2009, afastamento lateral é de no minímo <strong> $afast_lateral_minimo  m</strong> e de acordo com o projeto é de:  $afast_latEsq m.
 ...
 $html .="<tr>
    <td class='text-center'>Afastamento lateral esquerda</td>
        <td class='text-center'> $afast_latEsq  m</td>
        <td class='text-center'> $afast_lateral_minimo  m</td>
        <td class='text-center'><i class='fas fa-check fa-lg' style='color: green; margin-top: 5%;'></i></td>
        <td style='width:50%' class='text-left'>Aprovado. <i>(Favor considerar a cota lateral apartir da edificação até a projeção do cadastro da prefeitura (CP))</i></td>
...
$html .= "<tr >
        ...
        <td class='text-center'><i class='fas fa-times-circle fa-lg' style='color: #e00; margin-top: 5%;'></></td>
        <td style='width:50%' class='text-left'>Reprovado. De acordo com a lei 079/2009, afastamento frontal é de no minímo <strong> $afast_frontal_minimo  m</strong> e de acordo com o projeto é de:  $afast_frente m
...
$html .="<tr >
        ...
        <td class='text-center'><i class='fas fa-times-circle fa-lg' style='color: #e00; margin-top: 5%;'></></td>
        <td style='width:50%' class='text-left'>Reprovado. De acordo com a lei 079/2009, afastamento de fundos é de no minímo <strong> $afast_fundo_minimo  m</strong> e de acordo com o projeto é de:  $afast_fundos m
...
$html .="<tr>
        ...
        <td class='text-center'> $ca_permitido  m²</td>
        <td class='text-center'><i class='fas fa-check fa-lg' style='color: green; margin-top: 5%;'></></td>
        <td style='width:50%' class='text-left'>Aprovado <i>(O coeficiente de aproveitamento é a área máxima que poderá ser construída, nesse caso á área máxima é  $ca_permitido m²)</i> </td>
...
$html .="<tr >
        ...
        <td class='text-center'><i class='fas fa-times-circle fa-lg' style='color: #e00; margin-top: 5%;'></></td>
        <td style='width:50%' class='text-left'>Reprovado. De acordo com a lei 079/2009, a área mínima de permeabilidade é  de:  $tx_permeavel m².</td>
    </tr>";
...
$html .="<tr >
        ...
        <td class='text-center'><i class='fas fa-times-circle fa-lg' style='color: #e00; margin-top: 5%;'></></td>
        <td style='width:50%' class='text-left'>Reprovado. De acordo com a lei 079/2009, o numero mínimo de vagas é de  $_num_vagas  vaga. <i>(Obs: Lembrando que
